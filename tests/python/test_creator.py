...
def test_encoding_progressive_not_supported():
    ...
    data = [0, 1, 2, 255]
    frame = creator.add_frame(1, 1, Gly.MemoryFormat.R8G8B8A8, GLib.Bytes.new(data))

    assert not frame.set_encoding_progressive(True)
