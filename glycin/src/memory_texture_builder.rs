...
use gdk::{ffi, ColorState, MemoryFormat, Texture};
...
impl MemoryTextureBuilder {
    ...
    #[doc(alias = "bytes")]
    pub fn connect_bytes_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_bytes_trampoline<F: Fn(&MemoryTextureBuilder) + 'static>(
    ...
    pub fn connect_color_state_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_color_state_trampoline<
            F: Fn(&MemoryTextureBuilder) + 'static,
        >(
            this: *mut ffi::GdkMemoryTextureBuilder,
            _param_spec: glib::ffi::gpointer,
            f: glib::ffi::gpointer,
    ...
    pub fn connect_format_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_format_trampoline<F: Fn(&MemoryTextureBuilder) + 'static>(
            this: *mut ffi::GdkMemoryTextureBuilder,
            _param_spec: glib::ffi::gpointer,
            f: glib::ffi::gpointer,
        ) {
    ...
    pub fn connect_height_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_height_trampoline<F: Fn(&MemoryTextureBuilder) + 'static>(
            this: *mut ffi::GdkMemoryTextureBuilder,
            _param_spec: glib::ffi::gpointer,
            f: glib::ffi::gpointer,
        ) {
    ...
    #[doc(alias = "stride")]
    pub fn connect_stride_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_stride_trampoline<F: Fn(&MemoryTextureBuilder) + 'static>(
            this: *mut ffi::GdkMemoryTextureBuilder,
            _param_spec: glib::ffi::gpointer,
            f: glib::ffi::gpointer,
        ) {
    ...
    pub fn connect_width_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_width_trampoline<F: Fn(&MemoryTextureBuilder) + 'static>(
            this: *mut ffi::GdkMemoryTextureBuilder,
            _param_spec: glib::ffi::gpointer,
            f: glib::ffi::gpointer,
        ) {
